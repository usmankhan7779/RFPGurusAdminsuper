...
export class ViewSubscribeUserComponent implements OnInit {
  ...
  postoffer(page) {
    ...
    return this._serv.posttrialSubScriptionuer(this.pageSize, this.model.datefrom, this.model.dateto, this.model.fname, this.model.lname, this.model.email, page).subscribe(
